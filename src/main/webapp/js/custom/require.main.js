		...
		defaultConfigs = {
			...
			"map": {
				"*": {
					...
					"jmpress/active": "../js/jmpress-1.0.1/active",
					"jmpress/core": "../js/jmpress-1.0.1/core",
					"jmpress/hash": "../js/jmpress-1.0.1/hash",
					"jmpress/mobile": "../js/jmpress-1.0.1/mobile",
					"jmpress/near": "../js/jmpress-1.0.1/near",
					"jmpress/keyboard": "../js/jmpress-1.0.1/keyboard",
					"jmpress/transform": "../js/jmpress-1.0.1/transform",
					"jmpress/viewport": "../js/jmpress-1.0.1/viewport",
