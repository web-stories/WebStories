		...
		defaultConfigs = {
			...
			"map": {
				"*": {
					...
					"jmpress/active": "../js/jmpress-1.0.0-pre/active",
					"jmpress/circular": "../js/jmpress-1.0.0-pre/circular",
					"jmpress/core": "../js/jmpress-1.0.0-pre/core",
					"jmpress/hash": "../js/jmpress-1.0.0-pre/hash",
					"jmpress/mobile": "../js/jmpress-1.0.0-pre/mobile",
					"jmpress/near": "../js/jmpress-1.0.0-pre/near",
					"jmpress/start": "../js/jmpress-1.0.0-pre/start",
