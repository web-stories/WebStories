		...
		defaultConfigs = {
			...
			"map": {
				"*": {
					...
					"jmpress/active": "../js/jmpress-1.0.2/active",
					"jmpress/core": "../js/jmpress-1.0.2/core",
					"jmpress/hash": "../js/jmpress-1.0.2/hash",
					"jmpress/mobile": "../js/jmpress-1.0.2/mobile",
					"jmpress/near": "../js/jmpress-1.0.2/near",
					"jmpress/keyboard": "../js/jmpress-1.0.2/keyboard",
					"jmpress/transform": "../js/jmpress-1.0.2/transform",
					"jmpress/viewport": "../js/jmpress-1.0.2/viewport",
